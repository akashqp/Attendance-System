...
@app.route('/add')
def add():
    return render_template('New_User.html', totalreg=totalreg(), datetoday2=datetoday2)
...
def start():
    ...
    cv2.destroyAllWindows()
    names, rolls, times, l = extract_attendance()
    return render_template('Take_Attendance.html', names=names, rolls=rolls, times=times, l=l, totalreg=totalreg(),
